function shoeCatalogue() {
    ...
    function searchForItems(params) {
       ...
       for (let i = 0; i < shoes.length; i++) {
            ...
            if (shoe.brand === params.brand && shoe.color === params.color && shoe.size === params.size) {
                console.log(shoe);
                list.push(shoe)
            }

        //    else if (shoe.brand.toLowerCase() == params.brand.toLowerCase()) {
        //         list.push(shoe)
        //     }
        //     else if (shoe.color == params.color) {
        //         list.push(shoe)
        //     }
        //     else if (shoe.size == params.size) {
        //         list.push(shoe)
        //     }
